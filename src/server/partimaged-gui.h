...
public:
  ...
  virtual void show()=0;
  virtual void SetState(int client, const char * state)=0;
  virtual void SetHostname(int client, const char * state)=0;
  virtual void SetLocation(int client, const char * locate)=0;
  virtual void SetSize(int client, QWORD size)=0;
  virtual void SetSize(int client, const char * size)=0;
};
