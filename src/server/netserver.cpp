...
void CNetServer::ReleaseClientByPid(unsigned int client_pid)
{
  Clients->ReleaseClientByPid(client_pid);
}

unsigned int CNetServer::SetClientPid(unsigned int client, unsigned int client_pid)
{
  return Clients->SetClientPid(client, client_pid);
}
