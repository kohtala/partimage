...
public:
  ...
  virtual void msgBoxOk(const char *szTitle, const char *szText, ...);
  virtual int msgBoxYesNo(const char *szTitle, const char *szText, ...);
  virtual void msgBoxCancel(const char *szTitle, const char *szText, ...);
  virtual void msgBoxError(const char *szText, ...);
  virtual int msgBoxContinueCancel(const char *szTitle, const char *szText, ...);
