...
// =======================================================
void CImageNet::set_szPath(const char * str)
{
  lock(__LINE__);
...
// =======================================================
void CImageNet::set_szImageFilename(const char * str)
{
  lock(__LINE__);
...
// =======================================================
void CImageNet::set_szOriginalFilename(const char * str)
{
  lock(__LINE__);
...
// =======================================================
void CImageNet::set_szImageFilename(const char * str, int n)
{
  lock(__LINE__);
...
// =======================================================
void CImageNet::set_szOriginalFilename(const char * str, int n)
{
  lock(__LINE__);
